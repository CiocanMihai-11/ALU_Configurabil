...
class mediu_verificare extends uvm_env;
  ...
  agent_req_ack agent_req_ack_din_mediu;//agentul activ care furnizeaza stimuli si monitorizeaza interfata de intrare
...
agent_req_ack_din_mediu.de_la_monitor_req_ack.connect(IO_scorboard.port_pentru_datele_de_la_req_ack);
